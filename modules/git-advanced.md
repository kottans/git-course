...
This file should be considered a raw material and subject to review
and alignment with other course modules. 
...
[contributing with Git](./git-collaboration.md), and
[Git workflow and GitHub](./git-workflow-github.md)
